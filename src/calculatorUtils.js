...
export const solveFormula = (operation) =>
...
export const numberButtonClickHandler = (props) => {
  onClickHandler(props);
};

export const operationButtonClickHandler = (props) => {
  onClickHandler(props);
  props.setOperationAdded(true);
  props.setDecimalAdded(false);
};

export const decimalButtonClickHandler = (props) => {
...
export const equalsButtonClickHandler = (props) => {
...
export const clearButtonClickHandler = (props) => {
